  ...
  mapChart.setOption({
      ...
      series: [{
          ...
          data: [
            ...
            [120.590726,31.301557, '苏州大学附属第二医院三香路院区西8病区'] ,
            [120.520274,31.381822, '苏州大学附属第二医院浒关院区'],
            [120.590726,31.301559, '苏州大学附属第二医院三香路院区西7病区'],
            [120.590726,31.301555, '苏州大学附属第二医院三香路院区重症病区'],
           ]
      }]
  });
  ...
  pieChart1.setOption({
    ...
    legend: {
        ...
        textStyle : {
         ...
         data : ['苏州大学附属第二医院三香路院区西8病区','苏州大学附属第二医院浒关院区','苏州大学附属第二医院三香路院区西7病区','苏州大学附属第二医院三香路院区重症病区',],
    },
    tooltip : {
        trigger: 'item',
    ...
    series : [
        {
            ...
            data:[
                {value:335, name:'苏州大学附属第二医院三香路院区西8病区'},
                {value:310, name:'苏州大学附属第二医院浒关院区'},
                {value:234, name:'苏州大学附属第二医院三香路院区西7病区'},
                {value:135, name:'苏州大学附属第二医院三香路院区重症病区'}

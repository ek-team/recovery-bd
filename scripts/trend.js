 ...
 function init(){
   ...
   histogramChart1.setOption({
     ...
     xAxis : [
         {
             type : 'category',
             data : ['脑出血','脑梗死','癫痫','面神经炎','末梢神经炎','帕金森病','中风','阿尔茨海默病','其它'],
             axisLine:{
                  lineStyle:{
                      color: '#5bc0de'
                  },
   ...
   histogramChart2.setOption({
     ...
     yAxis : [
         {
             type : 'category',
             data : ['活动受限','恶心、呕吐、食欲不振','肌肉酸痛、乏力','持续高烧','头痛、眼眶痛、肌肉疼','皮疹、水泡','呼吸浅促','发热、咳嗽、流口水'],
             axisLine:{
                  lineStyle:{
                      color: '#FD6C88'
                  },
   ...
   histogramChart3.setOption({
     ...
     grid: {
      ...
      yAxis: [{
          show: true,
          data:  ['气动手','线驱手评估','下肢主被动','吞咽治疗','经颅磁	','下肢平衡','电刺激','其它'],
          inverse: true,
          axisLine: {
              show: false
          },
